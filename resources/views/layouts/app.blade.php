...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #00ffc3;">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('assets/img/BMT.png') }}" alt="Logo" height="40" class="d-inline-block align-text-top rounded-circle">
                    Berita Terkini Mamasa
                </a>
        ...
        <footer class="bg-dark text-white text-center py-3">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-12">
                        <p class="mb-0 mt-2">&copy; {{ date('Y') }} Berita Terkini Mamasa. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
